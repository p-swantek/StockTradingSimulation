...
public class UserCommandService {
    ...
    private static volatile UserCommandService theInstance = null;
    private static Map<String, Long> connectedUserIds; // Record of the Ids of connected users
    private static Map<String, User> connectedUsers; // Record of the connected users
    private static Map<String, Long> connectedTime; // Record of the time at which a user connects
    ...
    private void verifyUser(String userName, long connId) throws InvalidDataException, UserNotConnectedException, InvalidConnectionIdException {
        ...
        else if (!connectedUserIds.containsKey(userName.trim().toUpperCase())) {
        ...
        else if (connId != connectedUserIds.get(userName.trim().toUpperCase())) {
    ...
    public synchronized long connectUser(User user) throws InvalidDataException, AlreadyConnectedException {
        ...
        else if (connectedUserIds.containsKey(user.getUserName())) {
    ...
    public List<String> getProducts(String userName, long connId) throws InvalidDataException, UserNotConnectedException, InvalidConnectionIdException {
        if (userName == null || userName.trim().isEmpty()) {
