...
/**
 * Represents a facade with which the users of the trading system will interact.  Users will use this service in order to perform actions within the trading system such
 * as submitting/canceling orders and quotes.  Users will also be able to subscribe to publishers that will send relevant information to subscribed users.  This class
 * will allow for separation of the users from the implementation of the trading system.
 * 
...
public class UserCommandService {
	...
	public synchronized ArrayList<TradableDTO> getOrdersWithRemainingQty(String userName, long connId, String product) throws InvalidDataException, UserNotConnectedException, InvalidConnectionIdException {
		if (userName == null || userName.trim().isEmpty())
	...
	public String submitOrder(String userName, long connId, String product, Price price, int volume, String side) throws InvalidDataException, UserNotConnectedException, InvalidConnectionIdException, InvalidMarketStateException, NoSuchProductException {
		if (userName == null || userName.trim().isEmpty())
	...
	public void submitOrderCancel(String userName, long connId, String product, String side, String orderId) throws InvalidDataException, OrderNotFoundException, InvalidMarketStateException, NoSuchProductException, UserNotConnectedException, InvalidConnectionIdException {
		if (userName == null || userName.trim().isEmpty())
	...
	public void submitQuote(String userName, long connId, String product, Price buyPrice, int buyVolume, Price sellPrice, int sellVolume) throws InvalidDataException, UserNotConnectedException, InvalidConnectionIdException, InvalidMarketStateException, NoSuchProductException{
		if (userName == null || userName.trim().isEmpty())
	...
	public void submitQuoteCancel(String userName, long connId, String product) throws InvalidDataException, InvalidMarketStateException, NoSuchProductException, UserNotConnectedException, InvalidConnectionIdException{
		if (userName == null || userName.trim().isEmpty())
