...
/**
 * Maintains and records the relevant data for the position of a user in the trading system.  This class contains behavior and data that will allow the position of a user
 * to be updated and changed as the user makes trades within the trading system.  A user's postion will reflect his or her stock holdings as well as the balance of the
 * holdings and balance changes due to trading.
 * 
...
public class Position {
	...
	private HashMap<String, Integer> holdings = new HashMap<String, Integer>();  // Stock holdings
	private Price accountCosts = PriceFactory.makeLimitPrice("0.00");  // Initial account costs before any updates
	private HashMap<String, Price> lastSales = new HashMap<String, Price>();  // Record of all the previous sales for this user
	...
	public int getStockPositionVolume(String product) throws InvalidDataException {
		...
		if (!holdings.containsKey(product.trim().toUpperCase()))
			return 0;
	...
	public ArrayList<String> getHoldings() {
		...
		ArrayList<String> holdingKeys = new ArrayList<String>(holdings.keySet());
	...
	public Price getStockPositionValue(String product) throws InvalidDataException, InvalidPriceOperation {
		...
		if (holdings.get(product.trim().toUpperCase()) == null)
