 ...
 * 
 * A class to represent the quotes within the stock exchange.  A quote contains references to two 
 * QuoteSide objects, one representing the buy side of the quote and the other representing the sell side.
 *   
 */
...
public class Quote {
	...
	public Quote(String newUserName, String newProductSymbol, Price buyPrice,
			int buyVolume, Price sellPrice, int sellVolume) throws InvalidDataException {
