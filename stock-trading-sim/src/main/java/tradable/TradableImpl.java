 ...
 * 
 * 
 * A class that provides the default implementations for the Tradable interface.
 * Other classes that implement the Tradable interface will own a reference to
 * this implementation class. These classes can then delegate behaviors to be
 * performed by this implementation class.
 * 
...
public class TradableImpl implements Tradable {
    ...
    public TradableImpl(String newUserName, String newProductSymbol, Price orderPrice, int originalVolume, String newSide) throws InvalidDataException {
