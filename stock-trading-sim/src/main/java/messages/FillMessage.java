 ...
 * 
 * A class to represent the data regarding a fill of an order or a quote side within the stock exchange.
...
public class FillMessage implements Message, Comparable<FillMessage> {
	...
	public FillMessage(String newUser, String newProduct, Price newPrice, int newVolume,
