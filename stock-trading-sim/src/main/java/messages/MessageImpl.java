...
/**
 * A class that provides the default implementation of the Message interface.
 * Will maintain the common data fields for Messages as well as provide default
 * implementations for behaviors defined by the Message interface. This class
 * makes sure to set all data fields to valid values; there can be no null
 * Prices or Strings, and Strings can't be empty. The side must be set to a
 * valid side, which is represented by the two following Strings: "BUY" and
 * "SELL".
 * 
...
public class MessageImpl implements Message {
    ...
    public MessageImpl(String newUser, String newProduct, Price newPrice, int newVolume, String newDetails, String newSide, String newId) throws InvalidDataException {
