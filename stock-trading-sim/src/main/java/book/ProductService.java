 ...
 * 
 * 
 * This class serves as the facade to the trading system, will be implemented
 * using the singleton design patter so that only one instance of this class is
 * ever created; having two instances of this class provide access to the
 * trading system would most likely produce inconsistent results. This class
 * will keep a record of all the ProductBook objects that are associated with
 * individual stocks as well as maintain the status of the market (OPEN, CLOSED,
 * or PREOPEN). Users will interact with this class to perform actions within
 * the trading system.
 * 
